...
exec $JAVA_HOME/bin/java -classpath $CLASSPATH -Dsilverpeas.home=$SILVERPEAS_HOME org.silverpeas.setup.applicationbuilder.ApplicationBuilder -r ext_repository $1
